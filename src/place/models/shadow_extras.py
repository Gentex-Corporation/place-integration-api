"""Parked data models for the Place device shadow. Make available to HA core when adding features"""

from dataclasses import dataclass, field
from typing import Any

from .device_shadow import AlarmStatus
...
# TODO: Consolidate _FIELD_MAP / _NESTED_PARSERS into one declarative mapping that drives both full parse and sparse merge.
