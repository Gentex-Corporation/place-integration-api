"""Parked tests for the Place device shadow data models. Restore in Home Assistant Core test_models.py when adding more fields."""

from ..src.place.models import AlarmStatus
from ..src.place.models import PlaceDeviceShadow
